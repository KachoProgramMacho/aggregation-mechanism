...
public class DiagramGenerationRuntime2Test {
    ...
    public static void main(String... args) throws InterruptedException {
        ...
        XYChart chart = new XYChartBuilder().width(800).height(600).title("Visualization Times for Histogram and Time Series Chart").xAxisTitle("Number of entries in thousands").yAxisTitle("Time in milliseconds").build();
